...
* Esse repositório tem como finalidade demonstrar como aplicar o serviço <i> SES  (Amazon Simple Email Service) </i> no seu projeto, utilizando as melhores práticas de desenvolvimento.
